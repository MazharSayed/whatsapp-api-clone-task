    ...
    */
    ...
    'apps' => [
        [
            ...
            'id' => env('PUSHER_APP_ID', 'websockets-app-id'),
            'name' => env('PUSHER_APP_NAME', 'Laravel WebSockets App'),
            'key' => env('PUSHER_APP_KEY', 'websockets-app-key'),  // This should match the key in your .env
            'secret' => env('PUSHER_APP_SECRET', 'websockets-app-secret'),
            'cluster' => env('PUSHER_APP_CLUSTER', 'mt1'),
            'encrypted' => false,
            'enable_client_messages' => false,  // Set this to false if not used
            'enable_statistics' => true,
        ],
    ],
